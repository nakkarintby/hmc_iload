...
class _ReGoodReceivedState extends State<ReGoodReceived> {
  ...
  Future<void> documentIDCheck() async {
    ...
    var url = Uri.parse(
        'http://192.168.1.49:8111/api/api/document/validateregr/' +
            documentIdInput);
  ...
  Future<void> locationCheck() async {
    ...
    var url = Uri.parse(
        'http://192.168.1.49:8111/api/api/location/validateregr/' +
            documentIdInput +
            '/' +
            locationInput);
    http.Response response = await http.get(url);
  ...
  Future<void> gradeCheck() async {
    ...
    int binIdTemp = temp!;
    var url = Uri.parse(
        'http://192.168.1.49:8111/api/api/palletitem/validateregr/' +
            documentIdInput +
            '/' +
            gradeInput +
            '/' +

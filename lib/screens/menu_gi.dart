...
import 'package:test/screens/goods_issue.dart';
import 'package:test/screens/goods_received.dart';
import 'package:test/screens/re_goods_issue.dart';
import 'package:test/screens/re_goods_recived.dart';

class MenuGI extends StatelessWidget {
  @override
          ...
          child: Column(
            children: [
              ...
              MenuList(
                ...
                press: () => {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => ReGoodIssue()))
                },
              ),
            ],
          ),
